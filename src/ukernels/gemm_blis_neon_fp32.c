...
void gemm_microkernel_Cresident_neon_7x12_unroll_4_fp32_fixed(int mr, int nr, int kc, float alpha,
                                                              float *Ar,
                                                              float *Br,
                                                              float beta,
                                                              float *C, int ldC) {
...
void gemm_microkernel_Cresident_neon_7x12_nopackA_unroll_4_fp32_fixed(int mr, int nr, int kc, float alpha,
                                                                      float *Ar, int ldA,
                                                                      float *Br,
                                                                      float beta,
                                                                      float *C, int ldC) {
